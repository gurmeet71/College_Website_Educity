...
const About = ({setPlayState}) => {
  return (
    ...
    <div className="about-right">
        ...
        <p>
        With the focus in innovation, hands-on learning, and personalized mentorship, our prepare aspiring educators to make a meaningful impact in classrooms, schools, and communities. 
        </p>
        <p>
